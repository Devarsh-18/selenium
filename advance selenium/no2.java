...
public class no2 {
	...
	public void logintest(long MobNo, long pass) throws InterruptedException {
		...
		Thread.sleep(2000);
		WebElement lgn_Button = driver.findElement(By.xpath("//form[@id='loginForm']/div[3]/input"));
		lgn_Button.click();
	...
	public Object[][] data() {
		Q1ExcelFileReader ex = new Q1ExcelFileReader("C:\\Users\\reporto\\SS Tops.xlsx", "Login");
		int row = ex.rowCount();
